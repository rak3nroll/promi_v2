    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ route('billing.home') }}" class="nav-link">Home</a>
                </li>
            </ul>
            <!-- Right navbar links -->
        ...
        <div class="content-wrapper">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="{{ route('billing.home') }}">Home</a></li>
                                <li class="breadcrumb-item active">Approve Promisorry</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                <form action="/billing/record/{{ $Promisorris->id }}" method="post">
                    @method('PUT')
                    @include('forms.update_promi_forms')
                                    <div class="row">
                                        <div class="col-12">
                                            <a href="{{ route('billing.home') }}" class="btn btn-secondary">Back</a>
                                            @if ($Promisorris->is_posted == '0')
